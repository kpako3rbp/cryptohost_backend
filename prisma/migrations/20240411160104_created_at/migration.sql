...
INSERT INTO "new_NewsPost" ("body", "category_id", "deleted", "id", "image", "meta_title", "published_at", "slug", "title", "updated", "user_id") SELECT "body", "category_id", "deleted", "id", "image", "meta_title", "published_at", "slug", "title", "updated", "user_id" FROM "NewsPost";
DROP TABLE "NewsPost";
...
INSERT INTO "new_PromoBanner" ("deleted", "description", "id", "image", "meta_title", "slug", "title", "updated", "url", "user_id") SELECT "deleted", "description", "id", "image", "meta_title", "slug", "title", "updated", "url", "user_id" FROM "PromoBanner";
...
INSERT INTO "new_NewsCategory" ("deleted", "id", "name", "slug", "updated", "user_id") SELECT "deleted", "id", "name", "slug", "updated", "user_id" FROM "NewsCategory";
