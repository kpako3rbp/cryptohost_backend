...
INSERT INTO "new_NewsCategory" ("id", "name", "slug", "user_id") SELECT "id", "name", "slug", "user_id" FROM "NewsCategory";
...
INSERT INTO "new_NewsPost" ("body", "category_id", "id", "image", "meta_title", "published_at", "slug", "title", "user_id") SELECT "body", "category_id", "id", "image", "meta_title", "published_at", "slug", "title", "user_id" FROM "NewsPost";
DROP TABLE "NewsPost";
...
INSERT INTO "new_PromoBanner" ("description", "id", "image", "meta_title", "slug", "title", "url", "user_id") SELECT "description", "id", "image", "meta_title", "slug", "title", "url", "user_id" FROM "PromoBanner";
